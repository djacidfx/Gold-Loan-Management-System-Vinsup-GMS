...
const steps = ['Personal Detail', 'Jewel Detail', 'Approval Detail']; // Replace with your actual step names
        ...
        <Container maxWidth="lg">
          ...
          <div>
            {activeStep === steps.length ? (
              <div>
                <Typography variant="h5">All steps completed - Submit the form</Typography>
              </div>
            ) : (
              <div>
