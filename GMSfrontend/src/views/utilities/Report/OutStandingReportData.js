  ...
  return (
    <div>
      ...
      <Typography variant="subtitle1">
          ...
          <h2 style={{ fontFamily: 'poppins' }}> &nbsp;&nbsp;&nbsp;Out Standing Report</h2>
        </Typography>
      ...
      <div style={{ textAlign: 'center' }}>
            ...
            <Typography variant="subtitle1">
              ...
              >
                Out Standing Report {new Date().toLocaleDateString()}
              </h3>
            </Typography>
          </div>
        <div>
        ...
        <TableCell align="center" style={{ borderRight: '1px solid #000',borderBottom: '1px solid #000'  }}>Loan Amount</TableCell>
        ...
        <TableCell align="center"style={{borderRight: '1px solid #000',borderBottom: '1px solid #000'  }}>Balance</TableCell>
          ...
          <TableCell align="center" style={{ borderRight: '1px solid #000' ,borderBottom: '1px solid #000' }}>{row.loan_amount}</TableCell>
