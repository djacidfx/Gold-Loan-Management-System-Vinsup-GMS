    ...
    axios
      ...
      .then((response) => {
        ...
        const filteredData = loanapprovalsData.filter((loan) => {
            ...
            // Extract the date part (year, month, day) of dueDate and currentDate
            const dueDateOnly = new Date(dueDate.getFullYear(), dueDate.getMonth(), dueDate.getDate());
            const currentDateOnly = new Date(currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate());
            // Compare the date parts
            return dueDateOnly.getTime() === currentDateOnly.getTime() && loan.balance !== 0;
          });
  ...
  return (
    <div>
      ...
      <Typography variant="subtitle1">
          ...
          <h2 style={{ fontFamily: 'poppins' }}> &nbsp;&nbsp;&nbsp;DailyDateWiseDueLoans</h2>
        </Typography>
      ...
      <div style={{ textAlign: 'center' }}>
            ...
            <Typography variant="subtitle1">
              ...
              >
              DailyDateWiseDueLoans{new Date().toLocaleDateString()}
              </h3>
            </Typography>
          </div>
        <div>
