...
const UtilsLoanApproval = Loadable(lazy(() => import('views/utilities/LoanApproval')));

const UtilsLoanlist = Loadable(lazy(() => import('views/utilities/Loanlist')));
